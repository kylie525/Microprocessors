...
* Description: Create a sin wave from 0 to 2.5v at a frequency of 988 Hz using interrupts
*/
...
void tcc0_init(void)
{
	...
	// initialize the timer counter to 988 Hz
	TCC0.PER = 127;
	TCC0.CTRLA = TC_CLKSEL_DIV1_gc;
	
	/*
	// initialize the timer counter to 1188 Hz
	TCC0.PER = 106;
	TCC0.CTRLA = TC_CLKSEL_DIV1_gc;
	*/
	
	// set as medium level interrupts
